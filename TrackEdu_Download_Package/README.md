...
`app/build/outputs/apk/debug/app-debug.apk` (and copied to `apk/TrackEdu-v1.0-debug.apk`)
...
- `apk/TrackEdu-v1.0-release.apk` (and `apk/app-release.apk`)
- `TrackEdu_Download_Package/apk/TrackEdu-v1.0-release.apk`

*(Signed with RSA 2048-bit keystore `my-upload-key.jks`, configured via `keystore.properties`)*
